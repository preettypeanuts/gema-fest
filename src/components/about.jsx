            ...
            <section className="margin spacing">
                 <div className=" space-y-5">
                        <h1 className="font-heading text-2xl font-bold tracking-tight">
                            <span className="bg-linear-to-br from-white via-white to-mainColor bg-clip-text text-transparent">
                                Apa Itu GEMA Fest ?
                            </span>
                        </h1>

                        <p className="text-3xl font-medium bg-linear-to-br from-white via-white to-thirdColor bg-clip-text text-transparent">
