...
export const Navbar = () => {
    ...
    return (
        <>
            ...
            <nav className={`${isScrolled ? "bottom-7 " : "bottom-5"} left-1/2 -translate-x-1/2 md:hidden duration-500 ease-in-out fixed flex gap-1 z-100`}>
                {items.map((item, index) => (
                    <a href=""
                        key={index}
                    >
            ...
            <section className={`${isScrolled ? "translate-y-0" : "-translate-y-[300px]"} duration-300 hidden md:fixed -top-5 left-0 right-0 z-99`}>
                <GradualBlurMemo
                    target="parent"
                    position="top"
                    height="7rem"
            ...
            <section className={`${isScrolled ? "translate-y-0" : "translate-y-[300px]"} duration-300 fixed md:hidden -bottom-5 left-0 right-0 z-99`}>
                <GradualBlurMemo
                    target="parent"
                    position="bottom"
                    height="7rem"
